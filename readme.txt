...
3. Search for `Hooked On API` and click 'Install Now' or click on the `upload` link to upload `hooked-on-api.zip`
4. Click on `Activate plugin`

== Changelog ==

= 1.0.0: December 6, 2022 =
* Birthday of Hooked On API